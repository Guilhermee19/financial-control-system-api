"""
Django settings for financialControlSystemApi project.
...
ROOT_URLCONF = 'financialControlSystemApi.urls'
...
WSGI_APPLICATION = 'financialControlSystemApi.wsgi.application'
